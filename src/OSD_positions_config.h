...
#ifndef OSD_positions_config_H
#define OSD_positions_config_H
...
const uint16_t osd_rssi_value_pos = 2126;
const uint16_t osd_avg_cell_voltage_pos = 2509;
const uint16_t osd_gps_lon_pos = 2080;
const uint16_t osd_gps_lat_pos = 2048;
const uint16_t osd_flymode_pos = 2486;
const uint16_t osd_craft_name_pos = 2543;
const uint16_t osd_current_draw_pos = 2497;
const uint16_t osd_mah_drawn_pos = 2465;
const uint16_t osd_gps_sats_pos = 2113;
...
const uint16_t osd_numerical_vario_pos = 2298;
const uint16_t osd_gps_speed_pos = 2273;
const uint16_t osd_altitude_pos = 2106;
const uint16_t osd_home_dir_pos = 2447;
const uint16_t osd_home_dist_pos = 2074;
